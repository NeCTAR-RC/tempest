...
class Manager(clients.ServiceClients):
    ...
    def _set_volume_clients(self):
        ...
        #
        self.volumes_extensions_client = self.volume_v2.VolumesClient(
            **params_volume)
        self.compute_versions_client = self.volume_v3.VersionsClient(
            **params_volume)
        self.snapshots_extensions_client = self.volume_v2.SnapshotsClient(
            **params_volume)
